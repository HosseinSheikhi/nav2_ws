...
class overhead_camera {
 public:
  overhead_camera(double pose_x, double pose_y, double pose_z);
  overhead_camera(double pose_x, double pose_y, double pose_z, unsigned int image_height, unsigned int image_width);
  overhead_camera(double pose_x, double pose_y, double pose_z, unsigned int image_height, unsigned int image_width,
  ...
  bool isGridFree(unsigned int x_pixel, unsigned int y_pixel);
